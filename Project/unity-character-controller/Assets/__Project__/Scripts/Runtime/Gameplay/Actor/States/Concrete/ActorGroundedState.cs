namespace Gameplay
{
    public class ActorGroundedState : ActorBaseState, IRootState
    {
        #region CONSTRUCTOR

        public ActorGroundedState(ActorStateMachine currentContext, ActorStateFactory stateFactory) : base(currentContext, stateFactory)
        {
            Type = ActorState.Grounded;
