...
namespace Gameplay
{
    public class ActorFallState : ActorBaseState, IRootState
    {
        #region CONSTRUCTOR

        public ActorFallState(ActorStateMachine currentContext, ActorStateFactory stateFactory) : base(currentContext, stateFactory)
        {
            Type = ActorState.Fall;
