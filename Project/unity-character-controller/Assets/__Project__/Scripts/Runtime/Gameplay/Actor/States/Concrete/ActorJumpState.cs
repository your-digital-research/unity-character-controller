...
namespace Gameplay
{
    public class ActorJumpState : ActorBaseState, IRootState
    {
        #region CONSTRUCTOR

        public ActorJumpState(ActorStateMachine currentContext, ActorStateFactory stateFactory) : base(currentContext, stateFactory)
        {
            Type = ActorState.Jump;
