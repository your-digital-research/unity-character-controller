namespace Core.Gameplay.Character
{
    public class CharacterIdleState : CharacterBaseState
    {
        ...
        public CharacterIdleState(CharacterStateMachine currentContext, CharacterStateFactory stateFactory) : base(currentContext, stateFactory)
        {
            Type = CharacterState.Idle;
        }
